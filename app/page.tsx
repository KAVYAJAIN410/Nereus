...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-black text-white px-4 sm:px-6 lg:px-8 flex flex-col items-center">
      <div className={`max-w-3xl w-full transition-all duration-300 ${showForm ? "mt-28" : "mt-52"}`}>
        
        {/* Logo + Heading */}
        <div
          className={`${
            showForm ? "flex-row space-x-3" : "flex-col space-y-2"
        ...
        >
          ...
          >
            Welcome to your Nereus Experience.
          </h1>
        </div>
        ...
        {!showForm && (
          <div className="mt-10 flex justify-center">
            <button
              ...
              className="flex items-center gap-2 bg-[#5cd2ec] text-black px-5 py-3 rounded-full font-semibold"
            >
