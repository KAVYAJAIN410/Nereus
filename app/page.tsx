    ...
    <main className="min-h-screen bg-black py-12 px-4 sm:px-6 lg:px-8 text-white">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl text-[#5cd2ec] font-bold sm:text-4xl">Welcome to your Nereus Experience.</h1>
          <p className="mt-3 text-xl text-white">Book your personalized wellness assessment session</p>
        </div>
        <BookingForm />
      </div>
    </main>
